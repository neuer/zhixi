...
import { useExperimentLog } from "@/composables/useExperimentLog";
import { hoursOptions, useXApiDebug } from "@/composables/useXApiDebug";
import { formatNumber, formatTime } from "@/utils/format";
import { useRouter } from "vue-router";

const router = useRouter();
const { logs, addLog, toggleLog, toggleRaw, copyRaw, clearLogs } =
  useExperimentLog();
const {
  userHandle,
  tweetsHandle,
