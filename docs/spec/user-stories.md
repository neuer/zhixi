...
| 编号 | 标题 | 阶段 | 状态 | 依赖 |
|------|------|------|------|------|
| US-001 | 项目骨架初始化 | P0 | 🔲 待开发 | 无 |
| US-002 | 数据库初始化与迁移 | P0 | 🔲 待开发 | US-001 |
| US-003 | SQLite 备份 | P0 | 🔲 待开发 | US-002 |
| US-004 | 日志系统 | P0 | 🔲 待开发 | 无 |
| US-006 | 定时任务调度 | P0 | 🔲 待开发 | US-001 |
| US-010 | 大V账号管理 | P0 | 🔲 待开发 | US-002, US-008 |
| US-011 | BaseFetcher 抽象基类 | P0 | 🔲 待开发 | US-001 |
| US-012 | 推文分类器 | P0 | 🔲 待开发 | US-001 |
| US-013 | 每日自动抓取推文 | P0 | 🔲 待开发 | US-011, US-012, US-010 |
| US-014 | 单账号抓取失败容错 | P0 | 🔲 待开发 | US-013 |
| US-015 | X API 限流处理 | P0 | 🔲 待开发 | US-013 |
| US-047 | 推文分类器测试 | P0 | 🔲 待开发 | US-012 |
| US-053 | 备份与清理测试 | P0 | 🔲 待开发 | US-003 |
| US-017 | Claude API 客户端封装 | P1 | 🔲 待开发 | US-001, US-004 |
| US-018 | JSON 输出校验与修复 | P1 | 🔲 待开发 | US-001 |
| US-019 | 全局分析（第一步 AI） | P1 | 🔲 待开发 | US-017, US-018 |
| US-020 | 分批处理策略 | P1 | 🔲 待开发 | US-019 |
| US-021 | 逐条/逐话题 AI 加工 | P1 | 🔲 待开发 | US-017, US-018 |
| US-022 | 热度分计算 | P1 | 🔲 待开发 | US-001 |
| US-048 | JSON 校验测试 | P1 | 🔲 待开发 | US-018 |
| US-049 | 热度计算测试 | P1 | 🔲 待开发 | US-022 |
| US-007 | 首次设置向导 | P2 | 🔲 待开发 | US-002 |
| US-008 | 管理员登录认证 | P2 | 🔲 待开发 | US-002 |
| US-023 | 导读摘要生成 | P2 | 🔲 待开发 | US-017 |
| US-024 | 草稿组装与 digest_items | P2 | 🔲 待开发 | US-019, US-021, US-022 |
| US-025 | Markdown 渲染 | P2 | 🔲 待开发 | US-024 |
| US-026 | 封面图生成（可选） | P2 | 🔲 待开发 | US-024 |
| US-030 | 查看今日内容列表 | P2 | 🔲 待开发 | US-024, US-008 |
| US-031 | 编辑单条内容 | P2 | 🔲 待开发 | US-030 |
| US-032 | 编辑导读摘要 | P2 | 🔲 待开发 | US-030, US-025 |
| US-033 | 调整排序与置顶 | P2 | 🔲 待开发 | US-030 |
| US-034 | 剔除与恢复条目 | P2 | 🔲 待开发 | US-030 |
| US-039 | Vue 项目初始化 | P2 | 🔲 待开发 | US-007, US-008 |
| US-040 | Dashboard 首页 | P2 | 🔲 待开发 | US-039 |
| US-041 | 系统设置页 | P2 | 🔲 待开发 | US-039 |
| US-052 | Markdown 渲染测试 | P2 | 🔲 待开发 | US-025 |
| US-005 | Docker Compose 部署 | P3 | 🔲 待开发 | US-001 |
| US-027 | Pipeline 主流程编排 | P3 | 🔲 待开发 | US-013, US-019, US-021, US-024, US-028, US-029 |
| US-027b | 手动触发抓取 | P3 | 🔲 待开发 | US-013, US-028 |
| US-028 | 任务幂等锁 | P3 | 🔲 待开发 | US-002 |
| US-029 | 通知服务（Webhook） | P3 | 🔲 待开发 | US-001 |
| US-035 | 重新生成草稿 | P3 | 🔲 待开发 | US-027, US-028 |
| US-036 | 手动发布模式 | P3 | 🔲 待开发 | US-025, US-030 |
| US-037 | API 自动发布（预留） | P3 | 🔲 待开发 | US-036 |
| US-038 | 预览功能（登录态） | P3 | 🔲 待开发 | US-025, US-030 |
| US-042 | 推送历史页 | P3 | 🔲 待开发 | US-039 |
| US-043 | API 成本监控 | P3 | 🔲 待开发 | US-002 |
| US-044 | Dashboard 日志展示 | P3 | 🔲 待开发 | US-039, US-004 |
| US-050 | API 接口测试 | P3 | 🔲 待开发 | US-008, US-030 |
| US-051 | 状态流转测试 | P3 | 🔲 待开发 | US-024, US-035 |
| US-009 | 预览签名链接 | P4 | 🔲 待开发 | US-025, US-008 |
| US-016 | 手动补录推文 | P4 | 🔲 待开发 | US-011, US-021, US-024, US-030 |
| US-045 | 冷门日处理 | P4 | 🔲 待开发 | US-024 |
| US-046 | 超时未审核处理 | P4 | 🔲 待开发 | US-027 |
